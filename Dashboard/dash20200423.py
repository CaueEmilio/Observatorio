...
#test_png = 'C:/Users/aedua/Desktop/ENGMECATRONICA/PIBIC/Dash/Dash_finals/Dash_Final/logoObservatorioEPT.jpeg'
test_png = r'C:\Users\cauee\Desktop\Universidade\CEFET\IC\Dash\Dash_Final\logoObservatorioEPT.jpeg'
...
docentes = docentes[['ID-Lattes', 'Nome', 'Nível', 'Área', 'Linha de pesquisa', 'Instituicao', 'Patente']]  #organiza ordem exibição TAble Docentes
...
parametrosAtiv = ['Ganho de Oportunidade', 'Renda Mensal Média', 'Empregos', 'Estabelecimentos', 'Crescimento de Salários']
                    ...
                    html.Div([
                        ...
                        html.Div([
                            ...
                            html.Div(
                                ...
                                style={'max-height': '400px', 'width': '47%'},
                            ),
							#Cursos Pie
                            html.Div(
                            ...
                            html.Div([
								dash_table.DataTable(
									...
									style_table={'max-height': '220px', 'width': '1081px'},
                                    # export_format='xlsx',
                            ...
                            html.Div([
                                html.Div([
                                    ...
                                    html.Div(dcc.Slider(
                                        ...
                                        #min=df['Year'].min(),  # arrumar df6
                                        #max=df['Year'].max(),
                                        #value=df['Year'].max(),
                                        #marks={str(year): str(year) for year in df['Year'].unique()},
                                        # marks={int(year): year for year in anos},
                                        #step=None
                                    ...
                                    html.Div([
                                        dash_table.DataTable(
                                            id='top10ativ_table',
                                            columns=[{'name': 'Seção', 'id': 'industry_section'},{'name': 'Classe', 'id':'industry_class'}],
                                            ...
                                            fixed_rows={'headers': True, 'data': 0},
                                            style_table={'max-height': '380px', 'width': '760px'},
                                            # export_format='xlsx',
                                            # export_headers='display',
                                            # merge_duplicate_headers=True,
                                        ),
...
def update_cursosDropdown(selector_campus, selector_inst):
	...
	if selector_inst == "Todas":
		...
		return list(niveis), tipos.index
...
def update_docentesTable(selector_inst):
    if selector_inst == "Todas":
        ...
        area = mycolDoc.distinct("Área")
        return docentesCampus.to_dict("rows"), list(niveisDocCamp), [{'label': i, 'value': i} for i in niveisDocCamp], list(area), [
                   {'label': i, 'value': i} for i in area]
...
# Habilita dropdown Cidades - ABA ATIVIDADES
@app.callback(
...
def update_bar_atividades(selector):
	layout_pie = copy.deepcopy(layout)
	if selector == 'Todas':
		dff = df6
		data1 = [
		...
		figure2 = dict(data=data2, layout=layout_pie)
		
		return figure1, figure2
	
	elif (selector != 'Todas') and (selector in classe):
		dff = df6[df6['industry_class']==selector]
		data1 = [
			dict(
				type="bar",
				title='Renda média por estabelecimentos',
